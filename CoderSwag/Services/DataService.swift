...
class DataService {
    ...
    private let hats = [
        ...
        Product(title: "Devslopes Logo Hat Black", price: "$27", imageName: "hat02.png"),
        Product(title: "Devslopes Logo Hat White", price: "$28", imageName: "hat03.png"),
    ...
    private let hoodies = [
        ...
        Product(title: "Devslopes Hoodie Grey", price: "$45", imageName: "hoodie03.png"),
    ...
    private let shirts = [
        ...
        Product(title: "Devslopes Badge Shirt Light Grey", price: "$22", imageName: "shirt02.png"),
        Product(title: "Devslopes Logo Shirt Red", price: "$23", imageName: "shirt03.png"),
